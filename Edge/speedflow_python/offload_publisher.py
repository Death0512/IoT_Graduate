...
Publishes on one key expression:
  offload/plates/{src_node}/{dst_node} — L1 plate-crop (source offload_level==1; ~1–3 KB)
...
TYPE_PLATE   = "plate"    # L1 plate-crop (source offload_level==1)
...
class OffloadPublisher:
    """
    Non-blocking crop publisher for L1 plate-crop offload (source offload_level==1).
    ...
    def put_plate(
        ...
        """
        Enqueue a plate crop for L1 plate-crop offload (source offload_level==1).
